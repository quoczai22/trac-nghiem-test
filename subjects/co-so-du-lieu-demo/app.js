const SUBJECT_KEY = "co-so-du-lieu-demo";
...
const state = {
  bank: [],
  questions: [],
  answers: JSON.parse(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_answers") || "{}"),
  history: JSON.parse(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_history") || "[]"),
  filter: "all",
  submitted: JSON.parse(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_submitted") || "false"),
  autoSubmitted: JSON.parse(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_auto_submitted") || "false"),
  attemptRecorded: JSON.parse(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_attempt_recorded") || "false"),
  currentIndex: Number(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_current") || 0),
  deadline: Number(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_deadline") || 0),
  timerId: null,
};
...
function saveState() {
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_questions", JSON.stringify(state.questions));
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_answers", JSON.stringify(state.answers));
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_submitted", JSON.stringify(state.submitted));
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_auto_submitted", JSON.stringify(state.autoSubmitted));
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_attempt_recorded", JSON.stringify(state.attemptRecorded));
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_current", String(state.currentIndex));
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_deadline", String(state.deadline));
}

function saveHistory() {
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_history", JSON.stringify(state.history));
}
...
async function loadQuiz() {
  ...
  const oldSignature = localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_source_signature");
  ...
  if (sourceChanged) {
    ...
    state.currentIndex = 0;
    state.deadline = 0;
    localStorage.removeItem("quiz_subject_co-so-du-lieu-demo_random_questions");
  }
  localStorage.setItem("quiz_subject_co-so-du-lieu-demo_random_source_signature", sourceSignature);
  const savedQuestions = JSON.parse(localStorage.getItem("quiz_subject_co-so-du-lieu-demo_random_questions") || "null");
